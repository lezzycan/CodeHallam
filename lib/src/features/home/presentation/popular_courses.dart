                    ...
                    children: [
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                  image: AssetImage(
                                      popularCoursesContent[index].asset),
                                  fit: BoxFit.cover)),
                        ),
                      ),
                      gapH16,
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              popularCoursesContent[index].courseTitle,
                              style: GoogleFonts.fjallaOne(
                                  color: Color(0XFF2C2C2C),
                                  fontSize: 12.sp,
